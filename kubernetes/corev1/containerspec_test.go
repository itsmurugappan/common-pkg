...
func TestGetContainerSpec(t *testing.T) {
	for _, tc := range []struct {
		...
		inputModel    models.ContainerSpec
		...
		inputModel: models.ContainerSpec{Image: "docker.com/bar"},
		inputOptions: []containerSpecOption{
		...
		inputOptions: []containerSpecOption{
			...
			WithName(""),
			WithCommand([]string{""}),
			WithResources([]models.Resource{{"", int64(0), int64(0)}}),
		},
	}, {
		...
		inputModel: models.ContainerSpec{Image: "docker.com/bar"},
		inputOptions: []containerSpecOption{
			WithResources([]models.Resource{{"Requests", int64(10), int64(0)}, {"Limit", int64(0), int64(256)}}),
		},
	}, {
		...
		inputModel: models.ContainerSpec{Image: "docker.com/bar"},
		inputOptions: []containerSpecOption{
			WithResources([]models.Resource{{"Requests", int64(10), int64(128)}, {"Limit", int64(0), int64(0)}}),
		},
	}, {
		...
		inputModel: models.ContainerSpec{Image: "docker.com/bar"},
		inputOptions: []containerSpecOption{
			WithResources([]models.Resource{{"Requests", int64(0), int64(0)}, {"Limit", int64(10), int64(128)}}),
		},
	}} {
